...
//        switch (position) {
//            case 0:
//                Glide.with(viewHolder.itemView).load(R.drawable.bolt).into(viewHolder.imageViewSlider);
...
//                break;
//            case 1:
//                Glide.with(viewHolder.itemView).load(R.drawable.tinder_gold).into(viewHolder.imageViewSlider);
...
//                break;
//            case 2:
//                Glide.with(viewHolder.itemView).load(R.drawable.tinder_logo_black).into(viewHolder.imageViewSlider);
...
//
//            case 3:
//                Glide.with(viewHolder.itemView).load(R.drawable.tinder_logo).into(viewHolder.imageViewSlider);
...
//
//            case 4:
//                Glide.with(viewHolder.itemView).load(R.drawable.reverse).into(viewHolder.imageViewSlider);
